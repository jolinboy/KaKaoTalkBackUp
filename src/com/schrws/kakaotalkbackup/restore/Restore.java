package com.schrws.kakaotalkbackup.restore;
...
public class Restore extends Fragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View V = inflater.inflate(R.layout.restore_layout, container, false);
	...
	public void onClick(View v) {
		...
		case R.id.button1:
			...
			try{
				Runtime.getRuntime().exec("su -c chmod 777 /data/data/com.kakao.talk/databases/KakaoTalk.db");
			}
			catch(IOException e){
